...
public class calculatorproject1 implements ActionListener {
    ...
    JButton[] functionButtons = new JButton[13];//it will hold below buttons
    ...
    calculatorproject1(){
        ...
        panel = new JPanel();
        panel.setBounds(50,100,600,300);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == powButton){
            String str = textField.getText();
          Double st =  Math.pow(Double.parseDouble(str),Double.parseDouble(textField.getText()));
          textField.setText(String.valueOf(Double.parseDouble(String.valueOf(st))));
        }
